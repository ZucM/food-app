...
<body>
    ...
    <header>
        <nav>
            <div class="row">
                <img src="resources/img/logo-white.png" class="logo" alt="Logo">
                <img src="resources/img/logo.png" class="logo-black" alt="Logo">
    ...
    <section class="section-steps" id="works">
        ...
        <div class="row">
            <div class="col span-1-of-2 steps-box">
                <img src="resources/img/app-iPhone.png" alt="App window" class="app-screen js--wp-2">
            </div>
            <div class="col span-1-of-2 steps-box">
                ...
                <div class="plan-box js--wp-4">
                    ...
                    <div>
                        <ul>
                            ...
                            <li>
                                <ion-icon name="checkmark-outline" class="icon-small"></ion-icon>Access to newest
                                creations
                            </li>
                            <li>
                ...
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            ...
                            <li>
                                <ion-icon name="checkmark-outline" class="icon-small"></ion-icon>Order from 8 am to 12
                                pm
                            </li>
                            <li>
    ...
    <script src="https://kit.fontawesome.com/fab529f78d.js" crossorigin="anonymous"></script>
    ...
    <script src="https://cdn.jsdelivr.net/npm/selectivizr@1/selectivizr.min.js"></script>
